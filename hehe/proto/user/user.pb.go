...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19proto/common/common.proto\"\xb0\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"updated_by\x18\a \x01(\tR\tupdatedByB\r\n" +
	"\v_created_atB\r\n" +
	"\v_updated_at\"p\n" +
	...
	"\x06status\x18\x03 \x01(\x0e2\x10.user.UserStatusR\x06status\x12\x1d\n" +
	"\n" +
